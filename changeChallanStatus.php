<html>
    ...
    if($_REQUEST["btn"])
                {
                    ...
                    if($war!="")
                    {
                        ...
                        session_start();
                        $query= "update Challan set C_Status='Paid' where Vehicle_No='$war' " ;
    ...
    <body>
        ...
        <div id="centerdiv">
             <form method="POST"> 
                <h1>Change Status</h1>
            <input id="button" type="text" placeholder="Vehicle No" name="war"  > <br>
                    <input id="button" type='submit' name="btn" value="Submit "><br>
                 <?php
                if($value==2)
                    echo "<p style='color:red;'>Challan Status Changed</p>";?>
